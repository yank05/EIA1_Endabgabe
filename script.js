...
function LoadLevels() {
    ...
    let barCalculator = (barCounter / barTotal) * 100;
...
function goOn() {
    ...
    if (indexLevel > 0) {
        ...
        button.remove();
        let box = document.getElementById("flexwords");
        box.innerHTML = "";
